       ...
       return (
              <div className='sem1-container'>
                                         ...
                                         <div className='sem1-header'>
                                               ...
                                               <div className='sem1'>
                                                    <div className='sem1-logo'>
                                                      <h1 style={{fontSize: '20px'}}> Business Economics & Financial Analysis </h1>
                                               ...
                                               <div className='sem1'>
                                               <div className='sem1-logo'>
                                                      <h1 style={{fontSize: '20px'}}> Software Engineering</h1>
                                                        <img src={OS} alt=""  style={{width:'50px', margin:'10px'}}/>
                                                        
                                                    </div>
                                                      <a href=""> Software Engineering Notes</a>
                                                      <a href="">Notes-2</a>
                                                      <a href="">Class Notes</a>
                                                      <a href="">PYQ</a>
                                                      <a href="">Question paper</a>
                                         ...
                                         <div className='sem1-header'>
                                                 ...
                                                 <div className='sem1'>
                                                      <div className='sem1-logo'>
                                                        <h1 style={{fontSize: '20px'}}>Database Management Systems</h1>
                                                          <img src={PY} alt=""  style={{width:'50px', margin:'10px'}}/>
                                                          
                                                      </div>
                                                        <a href=""> Database Notes</a>
                                                        <a href="">Problem</a>
                                                        <a href="">Class Notes</a>
                                                        <a href="">PYQ</a>
                                                 ...
                                                 <div className='sem1'>
                                                 <div className='sem1-logo'>
                                                        <h1 style={{fontSize: '20px'}}>Discrete Mathematics</h1>
