                  ...
                  <h2>Learn and Grow</h2>
                   <div className='years-header'>
                        <div className='years'  style={backgroundStyle}>
                                <h1>1st Years</h1>
                                <button className='sem' onClick={handelAisem1}> 1st Sem</button>
                                <button className='sem' onClick={handelAisem2} > 2nd Sem</button>
                        </div>
                        <div className='years' style={backgroundStyle1} >
                        <h1>2nd Years</h1>
                                <button className='sem' onClick={handelAisem3}> 1st Sem</button>
                                <button className='sem' onClick={handelAisem4}> 2nd Sem</button>
                        </div>
                   </div>
                   ...
                   <div className='years-header'>
                        ...
                        <h1>3rd Years</h1>
                                <button className='sem' onClick={handelAisem5}> 1st Sem</button>
                                <button className='sem' onClick={handelAisem6}> 2nd Sem</button>
                        </div>
                        <div className='years' style={backgroundStyle4}>
                        <h1>4th Years</h1>
                                <button className='sem' onClick={handelAisem7}> 1st Sem</button>
                                <button className='sem'  onClick={handelAisem8}> 2nd Sem</button>
                        </div>
                   </div>
